...
export default function CampaignDisplayPage() {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel(`display-campaign-${campaignCode}`)
      .on(
        "postgres_changes",
  ...
  return (
    <>
      ...
      <main
        className={`min-h-screen text-white pt-0 px-8 pb-8 bg-cover bg-center bg-no-repeat transition-all duration-700 ${
      ...
      >
        {majorEnemies.length > 0 && (
          <section className="mb-8">
            <h2 className="text-4xl font-black text-purple-400 mb-4 text-center">
              Major Enemy
            </h2>
